  ...
  return (
    <main className="flex-1 w-full max-w-[1280px] mx-auto px-4 md:px-10 lg:px-40 py-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="relative h-[480px] w-full rounded-3xl overflow-hidden mb-12 group shadow-xl">
        <div className="absolute inset-0 bg-cover bg-center transition-transform duration-700 group-hover:scale-105" style={{ backgroundImage: 'url("https://images.unsplash.com/photo-1488459716781-6f3ee703f5b0?w=1200&h=600&fit=crop")' }}></div>
