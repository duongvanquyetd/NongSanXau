...
const Checkout: React.FC<CheckoutProps> = ({ onComplete, onBack }) => {
  return (
    <div className="flex-1 flex flex-col overflow-y-auto bg-background animate-in fade-in duration-500 pb-20">
      {/* Mini Nav Header */}
      <div className="bg-white border-b border-gray-100 py-4 px-4 md:px-10 lg:px-40 flex items-center justify-between sticky top-0 z-10">
