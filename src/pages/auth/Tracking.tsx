...
const Tracking: React.FC<TrackingProps> = ({ onBack }) => {
  ...
  return (
    <div className="flex-1 w-full overflow-y-auto bg-background animate-in fade-in duration-500">
      <div className="max-w-[1280px] mx-auto px-4 md:px-10 lg:px-40 py-12 pb-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-8 flex flex-col gap-8">
             <div className="relative aspect-[16/9] w-full rounded-[40px] overflow-hidden shadow-lg border border-gray-100 group bg-gray-100">
                <img src="Screenshot 2026-02-28 201052.png" className="w-full h-full object-cover grayscale opacity-60" />
