      ...
      <div className="max-w-[1280px] mx-auto px-4 md:px-10 lg:px-40 grid grid-cols-1 lg:grid-cols-12 gap-16">
        ...
        <div className="lg:col-span-5 flex flex-col gap-6">
          <div className="relative aspect-square rounded-[40px] overflow-hidden shadow-lg border border-gray-100 group">
            <img src="https://picsum.photos/seed/apple/800/800" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
          ...
          <div className="grid grid-cols-4 gap-4">
             ...
             <img src="https://picsum.photos/seed/orange/200/200" className="aspect-square rounded-2xl object-cover grayscale opacity-50 hover:grayscale-0 hover:opacity-100 cursor-pointer transition-all" />
             <img src="https://picsum.photos/seed/strawberry/200/200" className="aspect-square rounded-2xl object-cover grayscale opacity-50 hover:grayscale-0 hover:opacity-100 cursor-pointer transition-all" />
